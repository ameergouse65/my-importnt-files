...
const NewRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (isValid) {
      try {
        const response = await axios.post('http://localhost:9000/petex/signup', formValues);
  ...
  return (
    <div className='backgroundContainer2'>
      <div className='formContainer2'>
        <form onSubmit={handleSubmit} style={{ backgroundColor: 'transparent', borderRadius: '8px', padding: '20px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.6)', width: "700px", marginLeft: "10%", marginTop: "2%", color: "black", height: "820px" }}>
          <h2>Registration</h2>
