...
function Location() {
  return (
    <>
      <section>
      <div className="contact-right" style={{ marginLeft: "20%", marginTop: "5%", padding: "20px", backgroundColor:"#e6ccff", width:"550px", borderRadius: "15px" }}>
          <h3> Reach Us </h3>
          <table className="data">
            <tr>
              <td> Email : </td>
              <td> <a href="mailto:contactus@anarghyacomm.in">contactus@postofficecomm.in</a> </td>
            </tr>
